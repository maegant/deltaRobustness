...
%     set(gca,'xlim',[0,10])
    ...
    for i = 1:2
        item =  Animator.Sphere(robot_disp.axs, robot, ref_item{i}, ref_item{i}.Name, options{:});
    ...
    if robot.numState == 7
        ...
        item = Animator.Cylinder(robot_disp.axs, robot, frame, -frame.Offset, name, varargin{:});
        robot_disp.addItem(item);
        end   
