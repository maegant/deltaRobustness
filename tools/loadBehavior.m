...
function behavior = loadBehavior(behaviorName, is_symmetric, phaseType, ...
                       delay_coriolis, omit_coriolis, do_export_behavior, do_export_model,behavior_opts)
...
behavior.init(is_symmetric, phaseType, delay_coriolis, omit_coriolis,behavior_opts);
...
%%% Behavior
behavior_export_path = fullfile('export', 'behavior', behaviorName, 'sim');
