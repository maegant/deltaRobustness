...
function domain = SingleSupportFF_MI(domain, stanceLeg, phaseType,behavior_opts, whichImpact)
...
elseif isfield(behavior_opts,'Step')
    ...
    h_nsf_late = UnilateralConstraint(domain,ground_fun, 'nsfsteplate','x','AuxData',[step-dmax,step_x]);  
...
switch whichImpact
    ...
    case 'late'
        domain = addEvent(domain, h_nsf_late);
    otherwise
